...
class FirebaseSpeedNotificationServiceTest {
    private val notifier: ISpeedViolationNotifier = FirebaseSpeedNotificationService()
    ...
    fun `notifyCompany should log without throwing`() {
        ...
        verify {
            Log.d("FirebaseSpeedNotificationService", match { it.contains("notifyCompany") })
        }
    }
    ...
    fun `alertUser should log without throwing`() {
        ...
        verify {
            Log.d("FirebaseSpeedNotificationService", match { it.contains("alertUser") })
        }
    }
}